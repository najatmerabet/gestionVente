...
public class PdfAction extends ActionSupport {
    ...
    public String downloadPdf() throws UnsupportedEncodingException {
        ...
        this.pdfAction((int) session.getAttribute("idcomm"), (String) session.getAttribute("Username"), (float) session.getAttribute("total"));
        session.removeAttribute("idcomm");
    ...
    public void pdfAction(int idInvoice, String username, float total) throws UnsupportedEncodingException {
        ...
        String filePath = "C:/Users/NAJAT MRABET/Downloads/invoice.pdf";
    ...
    public String pdfForma(int idInvoice, String username, float total) {
        ...
        List<commande> commandes = dao.getallc();
        LocalDate dateCmd = commandes.get(0).getDateCmd().toLocalDate();
        ...
        contentHTML += " " + "<body style=\"background-color: #f5f5f5; padding: 0; text-align: center; background: rgb(236, 236, 236);\" bgcolor=\"rgb(236,\">\n" +
                ...
                "            <img class=\"web-img\" border=\"0\" src=\"https://www.google.com/url?sa=i&url=https%3A%2F%2Ffr.wikipedia.org%2Fwiki%2FRay-Ban&psig=AOvVaw2R4ZDQuEz3MoAstacj6LxR&ust=1686576414777000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCJjz2Nepu_8CFQAAAAAdAAAAABAE\" width=\"172\" height=\"auto\" style=\"border: none; display: inline-block; font-size: 14px; font-weight: bold; height: auto; outline: none; text-decoration: none; text-transform: capitalize; vertical-align: middle; margin-right: 10px; max-width: 100%;\">\n" +
                "          </a>\n" +
                "        </td>\n" +
                "      </tr>\n" +
                "      </tbody>\n" +
                ...
                + ",</span></p>\n" +
                "            <p style=\"margin: 0px;\">Thank you for your order on Shop4Makers.</p>\n" +
                ...
                "            <p style=\"margin: 0px;\">The Shop4Makers team</p>\n" +
                "          </div>\n" +
                "        </td>\n" +
                "      </tr>\n" +
                "      </tbody>\n" +
        ...
        for (commande com : commandes) {
            Articles_Stock articlesStock = new Articles_Stock();


            articlesStock = dao.getById(com.getCodeArt());
            if (articlesStock == null) {

            } else {

                //  System.out.println(articlesStock.getNomArt());
                System.out.println(com.getQteCmd());
                System.out.println(com.getQteCmd() * articlesStock.getPrixArt());
                ...
                contentHTML += "" + (com.getQteCmd() * articlesStock.getPrixArt());
                contentHTML +=
                        "\n" +
            ...
            contentHTML += " </tbody>\n" +
                    ...
                    "          <div class=\"element-text-content\" style=\"min-height: 10px;\">\n" +
                    "            <p style=\"font-size: 14px; margin: 0px 0px 16px; text-align: center;\" align=\"center\">Shop4Makers-Sale Glasses in Morocco</p>\t\t</div>\n" +
                    "        </td>\n" +
                    "      </tr>\n" +
                    "      </tbody>\n" +
                    "    </table>\n" +
